      ...
      <main className="flex-1 max-w-[1400px] mx-auto px-4 py-5 w-full">
        <Tabs defaultValue="macro" className="space-y-5">
          ...
          <TabsContent value="worldbank" className="space-y-5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
              <ChartCard title={t.chartWbGdpGrowth} subtitle={t.chartWbGdpGrowthSub}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
              <ChartCard title={t.chartWbInflation} subtitle={t.chartWbInflationSub}>
                <ChartContainer config={{ value: { label: t.wbKpiInflation, color: "#dc2626" } }} className="h-[300px] w-full">
                  <BarChart margin={{ top: 5, right: 10, left: -15, bottom: 0 }}>
                    <CartesianGrid strokeDasharray="3 3" stroke="#e2e8f0" />
                    <XAxis dataKey="year" tick={{ fontSize: 11 }} tickLine={false} />
              ...
              <ChartCard title={t.chartWbUnemp} subtitle={t.chartWbUnempSub}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
              <ChartCard title={t.chartWbTradeFdi} subtitle={t.chartWbTradeFdiSub}>
                <ChartContainer config={{ trade: { label: t.wbKpiTrade, color: "#0891b2" }, fdi: { label: t.wbKpiFdi, color: "#059669" } }} className="h-[300px] w-full">
                  <ComposedChart margin={{ top: 5, right: 10, left: -15, bottom: 0 }}>
                    <CartesianGrid strokeDasharray="3 3" stroke="#e2e8f0" />
                    <XAxis dataKey="year" tick={{ fontSize: 11 }} tickLine={false} />
                    <YAxis tick={{ fontSize: 11 }} />
                    <ChartTooltip content={<ChartTooltipContent />} />
              ...
              <ChartCard title={t.chartWbPopGrowth} subtitle={t.chartWbPopGrowthSub}>
