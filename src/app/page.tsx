    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex flex-col" style={arabicFontStyle}>
      ...
      <main className="flex-1 max-w-[1400px] mx-auto px-4 py-5 w-full">
        <Tabs defaultValue="macro" className="space-y-5">
          ...
          <TabsContent value="worldbank" className="space-y-5">
            {/* ── Row 1: 8 KPI cards (2 rows of 4) ── */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              <KpiCard title={t.wbKpiGdp} value={worldBankKPIs.gdpGrowthWb} unit="%" icon={TrendingUp} color={COLORS.emerald} />
              <KpiCard title={t.wbKpiInflation} value={worldBankKPIs.inflationWb} unit="%" icon={Scale} color={COLORS.red} />
              <KpiCard title={t.wbKpiPop} value={worldBankKPIs.populationWb} unit="M" icon={Users} color={COLORS.blue} />
              <KpiCard title={t.wbKpiGni} value={worldBankKPIs.gniPerCapita} unit="$" icon={DollarSign} color={COLORS.purple} />
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              <KpiCard title={t.wbKpiUnemp} value={worldBankKPIs.unemploymentWb} unit="%" icon={Users} color={COLORS.amber} />
              <KpiCard title={t.wbKpiTrade} value={worldBankKPIs.tradeGdpPct} unit="% GDP" icon={Globe} color={COLORS.cyan} />
              <KpiCard title={t.wbKpiFdi} value={worldBankKPIs.fdiPct} unit="%" icon={TrendingUp} color={COLORS.teal} />
              <KpiCard title={t.wbKpiDebt} value={worldBankKPIs.externalDebtPct} unit="% GNI" icon={DollarSign} color={COLORS.rose} />
            </div>

            {/* ── Row 2: 5 additional KPI cards ── */}
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
              <KpiCard title={t.wbKpiLifeExp} value={worldBankKPIs.lifeExpectancy} unit={"yr"} icon={Heart} color={COLORS.purple} />
              <KpiCard title={t.wbKpiPoverty} value={worldBankKPIs.povertyRate} unit="%" icon={Users} color={COLORS.rose} />
              <KpiCard title={t.wbKpiCo2} value={worldBankKPIs.co2PerCapita} unit={"t/cap"} icon={FactoryIcon} color={COLORS.slate} />
              <KpiCard title={t.wbKpiRenewable} value={worldBankKPIs.renewableEnergy} unit="%" icon={Sun} color={COLORS.emerald} />
              <KpiCard title={t.wbKpiInternet} value={worldBankKPIs.internetUsers} unit="%" icon={Wifi} color={COLORS.blue} />
            </div>
              ...
              <ChartCard title={t.chartWbVsOnsGdp} unit="%" data={filterByYear(worldBankGdpGrowth)} subtitle={t.chartWbVsOnsGdpSub}>
                <ChartContainer config={{ wb: { label: t.labelWb, color: COLORS.cyan }, ons: { label: t.labelOns, color: COLORS.emerald } }} className="h-[300px] w-full">
                  <LineChart data={filterByYear(worldBankGdpGrowth)} margin={{ top: 5, right: 10, left: -15, bottom: 0 }}>
                    ...
                    <Line type="monotone" dataKey="wb" stroke={COLORS.cyan} strokeWidth={2} dot={{ fill: COLORS.cyan, r: 3 }} name={t.labelWb} />
              ...
              <ChartCard title={t.chartWbVsOnsInflation} unit="%" data={filterByYear(worldBankInflation)} subtitle={t.chartWbVsOnsInflationSub}>
                <ChartContainer config={{ wb: { label: t.labelWb, color: COLORS.red }, ons: { label: t.labelOns, color: COLORS.rose } }} className="h-[300px] w-full">
                  <LineChart data={filterByYear(worldBankInflation)} margin={{ top: 5, right: 10, left: -15, bottom: 0 }}>
                    ...
                    <ChartTooltip content={<ChartTooltipContent />} />
                    <ChartLegend content={<ChartLegendContent />} />
                    <Line type="monotone" dataKey="wb" stroke={COLORS.red} strokeWidth={2} dot={{ fill: COLORS.red, r: 3 }} name={t.labelWb} />
                    <Line type="monotone" dataKey="ons" stroke={COLORS.rose} strokeWidth={2} dot={{ fill: COLORS.rose, r: 3 }} strokeDasharray="6 3" name={t.labelOns} />
                  </LineChart>
                </ChartContainer>
              </ChartCard>
            </div>
              ...
              <ChartCard title={t.chartWbVsOnsUnemp} unit="%" data={filterByYear(worldBankUnemployment)} subtitle={t.chartWbVsOnsUnempSub}>
                <ChartContainer config={{ wb: { label: t.labelWb, color: COLORS.amber }, ons: { label: t.labelOns, color: COLORS.orange } }} className="h-[300px] w-full">
                  <LineChart data={filterByYear(worldBankUnemployment)} margin={{ top: 5, right: 10, left: -15, bottom: 0 }}>
                    ...
                    <ChartTooltip content={<ChartTooltipContent />} />
                    <ChartLegend content={<ChartLegendContent />} />
                    <Line type="monotone" dataKey="wb" stroke={COLORS.amber} strokeWidth={2} dot={{ fill: COLORS.amber, r: 3 }} name={t.labelWb} />
                    <Line type="monotone" dataKey="ons" stroke={COLORS.orange} strokeWidth={2} dot={{ fill: COLORS.orange, r: 3 }} strokeDasharray="6 3" name={t.labelOns} />
                  </LineChart>
                </ChartContainer>
              </ChartCard>
              ...
              <ChartCard title={t.chartWbExtDebt} unit="% RNB" data={filterByYear(worldBankExternalDebt)} subtitle={t.chartWbExtDebtSub}>
                <ChartContainer config={{ debt: { label: t.wbKpiDebt, color: COLORS.rose } }} className="h-[300px] w-full">
                  <AreaChart data={filterByYear(worldBankExternalDebt)} margin={{ top: 5, right: 10, left: -15, bottom: 0 }}>
                    ...
                    <YAxis tick={{ fontSize: 11 }} />
                    <ChartTooltip content={<ChartTooltipContent />} />
                    <Area type="monotone" dataKey="debt" stroke={COLORS.rose} fill={COLORS.roseLight} fillOpacity={0.4} strokeWidth={2} name={t.wbKpiDebt} />
                  </AreaChart>
                </ChartContainer>
              </ChartCard>
              <ChartCard title={t.chartWbLifeExp} unit="Années" data={filterByYear(worldBankLifeExpectancy)} subtitle={t.chartWbLifeExpSub}>
                <ChartContainer config={{ male: { label: t.labelMale, color: COLORS.blue }, female: { label: t.labelFemale, color: COLORS.rose } }} className="h-[300px] w-full">
                  <AreaChart data={filterByYear(worldBankLifeExpectancy)} margin={{ top: 5, right: 10, left: -15, bottom: 0 }}>
                    ...
                    <ChartTooltip content={<ChartTooltipContent />} />
                    <ChartLegend content={<ChartLegendContent />} />
                    <Area type="monotone" dataKey="male" stroke={COLORS.blue} fill={COLORS.blueLight} fillOpacity={0.25} strokeWidth={2} name={t.labelMale} />
                    <Area type="monotone" dataKey="female" stroke={COLORS.rose} fill={COLORS.roseLight} fillOpacity={0.25} strokeWidth={2} name={t.labelFemale} />
                  </AreaChart>
                </ChartContainer>
              </ChartCard>
            </div>
              ...
              <ChartCard title={t.chartWbPoverty} unit="%" data={filterByYear(worldBankPoverty)} subtitle={t.chartWbPovertySub}>
                <ChartContainer config={{ poverty215: { label: t.labelPoverty215, color: COLORS.red }, poverty365: { label: t.labelPoverty365, color: COLORS.amber }, povertyNational: { label: t.labelPovertyNat, color: COLORS.slate } }} className="h-[300px] w-full">
                  <BarChart data={filterByYear(worldBankPoverty)} margin={{ top: 5, right: 10, left: -15, bottom: 0 }}>
                    ...
                    <ChartTooltip content={<ChartTooltipContent />} />
                    <ChartLegend content={<ChartLegendContent />} />
                    <Bar dataKey="povertyNational" stackId="a" fill={COLORS.slate} radius={[0, 0, 0, 0]} name={t.labelPovertyNat} />
                    <Bar dataKey="poverty365" stackId="a" fill={COLORS.amber} radius={[0, 0, 0, 0]} name={t.labelPoverty365} />
                    <Bar dataKey="poverty215" stackId="a" fill={COLORS.red} radius={[2, 2, 0, 0]} name={t.labelPoverty215} />
                  </BarChart>
                </ChartContainer>
              </ChartCard>
              <ChartCard title={t.chartWbCo2} unit="t/hab" data={filterByYear(worldBankCo2Emissions)} subtitle={t.chartWbCo2Sub}>
                <ChartContainer config={{ co2: { label: t.labelCo2, color: COLORS.slate } }} className="h-[300px] w-full">
                  <BarChart data={filterByYear(worldBankCo2Emissions)} margin={{ top: 5, right: 10, left: -15, bottom: 0 }}>
                    ...
                    <ChartTooltip content={<ChartTooltipContent />} />
                    <Bar dataKey="co2" name={t.labelCo2} radius={[2, 2, 0, 0]}>
                      {worldBankCo2Emissions.map((d: { co2: number }, i: number) => (
                        <Cell key={i} fill={d.co2 >= 3.5 ? COLORS.red : d.co2 >= 3.2 ? COLORS.amber : COLORS.emerald} />
                      ))}
                    </Bar>
                  </BarChart>
                </ChartContainer>
              ...
              <ChartCard title={t.chartWbEnergy} unit="%" data={filterByYear(worldBankEnergyAccess)} subtitle={t.chartWbEnergySub}>
                <ChartContainer config={{ electricity: { label: t.labelElectricity, color: COLORS.amber }, renewable: { label: t.labelRenewable, color: COLORS.emerald } }} className="h-[300px] w-full">
                  <ComposedChart data={filterByYear(worldBankEnergyAccess)} margin={{ top: 5, right: 10, left: -15, bottom: 0 }}>
                    ...
                    <ChartTooltip content={<ChartTooltipContent />} />
                    <ChartLegend content={<ChartLegendContent />} />
                    <Line yAxisId="left" type="monotone" dataKey="electricity" stroke={COLORS.amber} strokeWidth={2} dot={{ fill: COLORS.amber, r: 3 }} name={t.labelElectricity} />
                    <Bar yAxisId="right" dataKey="renewable" fill={COLORS.emerald} radius={[4, 4, 0, 0]} opacity={0.6} name={t.labelRenewable} />
                  </ComposedChart>
                </ChartContainer>
              </ChartCard>
            </div>
              ...
              <ChartCard title={t.chartWbTradeFdi} unit="% PIB" data={filterByYear(worldBankTradeGdp)} subtitle={t.chartWbTradeFdiSub}>
                <ChartContainer config={{ exports: { label: t.labelExports, color: COLORS.emerald }, imports: { label: t.labelImports, color: COLORS.red }, trade: { label: t.labelTradeOpenness, color: COLORS.cyan } }} className="h-[300px] w-full">
                  <ComposedChart data={filterByYear(worldBankTradeGdp)} margin={{ top: 5, right: 10, left: -15, bottom: 0 }}>
                    ...
                    <ChartTooltip content={<ChartTooltipContent />} />
                    <ChartLegend content={<ChartLegendContent />} />
                    <Bar dataKey="exports" fill={COLORS.emerald} radius={[2, 2, 0, 0]} opacity={0.7} name={t.labelExports} />
                    <Bar dataKey="imports" fill={COLORS.red} radius={[2, 2, 0, 0]} opacity={0.7} name={t.labelImports} />
                    <Line type="monotone" dataKey="trade" stroke={COLORS.cyan} strokeWidth={2} dot={{ r: 3 }} name={t.labelTradeOpenness} />
                  </ComposedChart>
                </ChartContainer>
              </ChartCard>
