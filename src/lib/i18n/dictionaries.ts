...
export interface Dictionary {
  ...
  // ─── BENCHMARKING (COMPARAISON INTERNATIONALE) ───────────────────
  tabBenchmarking: string;
  benchTabOverview: string;
  benchTabGrowth: string;
  benchTabSocial: string;
  benchTabDigital: string;
  benchTabFiscal: string;
  benchFocus: string;
  benchPop: string;
  benchGdp: string;
  benchGni: string;
  benchRadar: string;
  benchRadarSub: string;
  benchSummary: string;
  benchSummarySub: string;
  benchIndicator: string;
  benchBest: string;
  benchGdpGrowth: string;
  benchGdpGrowthSub: string;
  benchGdpCapita: string;
  benchInflation: string;
  benchTrade: string;
  benchUnemp: string;
  benchFdi: string;
  benchLifeExp: string;
...
const fr: Dictionary = {
  ...
  tabBenchmarking: "Comparaison Internationale",
...
const ar: Dictionary = {
  ...
  kpiSdgAchieved: "2",
  kpiSdgOverview: "نظرة عامة على 17 هدف",
  chartSdgProgress: "تقدم أهداف التنمية المستدامة",
  chartSdgProgressSub: "حالة تقدم أهداف 2030",
  chartSdgIndicators: "مؤشرات رئيسية مقابل أهداف 2030",
  chartSdgIndicatorsSub: "مرجع 2015 / الأخير / هدف 2030",
